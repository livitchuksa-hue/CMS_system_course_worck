...
public partial class ContainerElementView : UserControl
{
    public ContainerElementView() => InitializeComponent();
    ...
    private void Container_Drop(object sender, DragEventArgs e)
    {
        ...
        var vm = FindEditorVm();
        if (vm == null) return;
        if (!e.Data.GetDataPresent(typeof(ElementType))) return;
